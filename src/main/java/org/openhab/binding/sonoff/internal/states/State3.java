...
/**
 * The {@link State3} contains the state of a device with uiid 3
 *
...
public class State3 extends StateBase {
    ...
    private @Nullable DeviceListener<State3> listener;
    ...
    public void sendUpdate() {
        final DeviceListener<State3> listener = this.listener;
        if (listener != null) {
    ...
    public void setDeviceListener(@Nullable DeviceListener listener) {
        this.listener = (@Nullable DeviceListener<State3>) listener;
    }

...
/**
 * The {@link State77} contains the state of a device with uiid 77
 *
 * @author David Murton - Initial contribution
 */
@NonNullByDefault
public class State77 extends StateBase {

    private @Nullable DeviceListener<State77> listener;
    ...
    public void sendUpdate() {
        final DeviceListener<State77> listener = this.listener;
        if (listener != null) {
    ...
    public void setDeviceListener(@Nullable DeviceListener listener) {
        this.listener = (@Nullable DeviceListener<State77>) listener;
    }

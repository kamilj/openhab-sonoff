 ...
 */
@NonNullByDefault
public class Handler4 extends HandlerBaseDual<State4> {

    private final Logger logger = LoggerFactory.getLogger(Handler4.class);
    private final Gson gson;
    private @Nullable ScheduledFuture<?> localTask;

    public Handler4(Thing thing, Gson gson) {
        super(thing, gson);
        this.gson = gson;
    }

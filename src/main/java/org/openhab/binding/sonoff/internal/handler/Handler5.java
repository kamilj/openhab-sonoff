...
/**
 * The {@link Handler5} allows the handling of commands and updates to Devices with uuid 32
 *
 * @author David Murton - Initial contribution
 */
@NonNullByDefault
public class Handler5 extends HandlerBaseDual<State5> {

    private final Logger logger = LoggerFactory.getLogger(Handler5.class);
    private final Gson gson;
    private @Nullable ScheduledFuture<?> localTask;
    private @Nullable ScheduledFuture<?> consumptionTask;

    public Handler5(Thing thing, Gson gson) {
        super(thing, gson);
        this.gson = gson;
    }
    ...
    @Override
    public void updateDevice(State5 newDevice) {
        // Switches

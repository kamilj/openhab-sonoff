...
/**
 * The {@link State2} contains the state of a device with uiid 2
 *
...
public class State2 extends StateBase {
    ...
    private @Nullable DeviceListener<State2> listener;
    ...
    public void sendUpdate() {
        final DeviceListener<State2> listener = this.listener;
        if (listener != null) {
    ...
    public void setDeviceListener(@Nullable DeviceListener listener) {
        this.listener = (@Nullable DeviceListener<State2>) listener;
    }

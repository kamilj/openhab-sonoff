...
/**
 * The {@link Handler77} allows the handling of commands and updates to Devices with uuid's:
 * 1
 *
 * @author David Murton - Initial contribution
 */
@NonNullByDefault
public class Handler77 extends HandlerBaseDual<State77> {

    private final Logger logger = LoggerFactory.getLogger(Handler77.class);
    private final Gson gson;
    private @Nullable ScheduledFuture<?> localTask;

    public Handler77(Thing thing, Gson gson) {
        super(thing, gson);
        this.gson = gson;
    }
    ...
    @Override
    public void updateDevice(State77 newDevice) {
